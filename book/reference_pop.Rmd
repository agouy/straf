...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_ref_pop_1.png")
```
:::
...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_ref_pop_2.png")
```
:::
...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_ref_pop_3.png")
```
:::
...
:::{.capture_small}
```{r}
knitr::include_graphics("img/capture_ref_excel_1.png")
```
:::
...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_ref_excel_2.png")
```
:::
