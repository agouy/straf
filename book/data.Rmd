...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_excel_1.png")
```
:::
...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_excel_2.png")
```
:::
...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_import_1.png")
```
:::
...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_import_2.png")
```
:::
...
:::{.capture}
```{r}
knitr::include_graphics("img/capture_import_3.png")
```
:::
